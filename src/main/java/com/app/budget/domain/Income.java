...
public class Income extends FinancialOccurrence {
    ...
    public Income(Long id, Set<Category> categories, String title, Double value, LocalDate dueDate, IncomeStatus status) {
    ...
    public Income(Set<Category> categories, String title, Double value, LocalDate dueDate, IncomeStatus status) {
