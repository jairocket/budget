...
public class BoardTest {
    ...
    public void shouldBeAbleToGetExpensesTotal() {
        ...
        Set<Category> categories = Set.of(category_1);
        Expense expense_1 = new Expense(categories, "Uber", 30.00, LocalDate.of(2024, 3, 1), ExpenseStatus.PENDING);
        Expense expense_2 = new Expense(categories, "Uber", 25.00, LocalDate.of(2024, 3, 2), ExpenseStatus.PENDING);
        Expense expense_3 = new Expense(categories, "Uber", 45.00, LocalDate.of(2024, 3, 3), ExpenseStatus.PENDING);
